    ...
    <transition name="fade">
      <nav v-if="show">
        <van-tabbar v-model="active" class="nav">
          <van-tabbar-item icon="home-o" @click="redirect('nodePage')"
            >笔记</van-tabbar-item
          >
          <van-tabbar-item icon="todo-list-o" @click="redirect('general')"
            >概览</van-tabbar-item
          >
          <van-tabbar-item icon="search" @click="redirect('tool')"
            >工具</van-tabbar-item
          >
          <van-tabbar-item icon="setting-o" @click="redirect('userInfo')"
            >设置</van-tabbar-item
          >
        </van-tabbar>
      </nav>
